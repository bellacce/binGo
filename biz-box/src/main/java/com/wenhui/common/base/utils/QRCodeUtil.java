...
public class QRCodeUtil {
    ...
    public static String getQRcodeStream(HttpServletResponse response, String content, String param) {
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
        createCodeToOutputStream(content, outputStream);
...
//                    response.getWriter().close();
    ...
    public static String getQRcodeStream(String content, String param) {
        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
        createCodeToOutputStream(content, outputStream);
        byte[] data = outputStream.toByteArray();
        BASE64Encoder encoder = new BASE64Encoder();
