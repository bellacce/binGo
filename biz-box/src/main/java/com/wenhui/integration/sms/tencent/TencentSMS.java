...
public class TencentSMS extends AbstractClient {
    ...
    public TencentSMS(Credential credential, String region) {
        this(credential, region, new ClientProfile());
    }

    public TencentSMS(Credential credential, String region, ClientProfile profile) {
        super(TencentSMS.endpoint, TencentSMS.version, credential, region, profile);
    }
